...
\section{Technical Design}
	...
	\subsection{Web Application}
		...
		\end{minipage}\\
		\\
		Then we chose from the plethora of existing frameworks seven which are commonly used in web app development to compare agents these requirements. The each criteria is marked on a log scale of ether 1,3, or 9 and displayed in Table~\ref{WebMatrix}.
