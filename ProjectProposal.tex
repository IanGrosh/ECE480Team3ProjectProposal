...
\section{Technical Design}
	...
	\subsection{Web Application}
		...
		\begin{itemize}
			...
			\item \textbf{Revel} \\
			Revel is the go language web framework. As with menny things in go there is one right way to do something and this is it.
...
\part{Cost}
The only cost incurred by the design team will be purchasing a Nexus 7 tablet of the same model year or simillar the sponsors devices due to their security measures we are un-able to use one of the sponsor owns devises. untill such time as one can be procured, a group member has volunteered there nexus7 tablet to be used.
