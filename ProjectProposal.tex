...
\section{Background Research}\label{research}
	...
	In order to assess the customer's need the team must first understand the problem.
	...
	\cite{nexus7}
	SOMEONE CITE THIS PLEASE http://www.gsmarena.com/asus\_google\_nexus\_7-4850.php \\
